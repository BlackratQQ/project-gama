...
export interface TestimonialEffectsProps {
  enableStars?: boolean;
...
const TestimonialMagicEffects: React.FC<TestimonialEffectsProps> = ({
  enableStars = true,
  ...
  useEffect(() => {
    ...
    cards.forEach((card) => {
      ...
      if (enableBorderGlow) {
        element.classList.add('testimonial-card--border-glow');
      }
    ...
    if (enableSpotlight) {
      ...
      spotlight.className = 'testimonial-global-spotlight';
    ...
    <>
      <style>
        {`
          ...
          .testimonial-card--border-glow::after {
            content: '';
            position: absolute;
            inset: 0;
            padding: 6px;
          ...
          .testimonial-card--border-glow:hover::after {
            opacity: 1;
          }
...
export default TestimonialMagicEffects;
