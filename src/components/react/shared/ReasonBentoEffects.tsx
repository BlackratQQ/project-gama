...
const ReasonBentoEffects: React.FC<BentoEffectsProps> = ({
  enableStars = true,
  ...
  useEffect(() => {
    ...
    cards.forEach((card) => {
      ...
      if (enableBorderGlow) {
        element.classList.add('reason-card--border-glow');
      }
    ...
    if (enableSpotlight) {
      ...
      spotlight.className = 'reason-global-spotlight';
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const section = document.querySelector('.reason-section');
    ...
    <>
      <style>
        {`
          ...
          .reason-card--border-glow:hover::after {
            opacity: 1;
          }
...
export default ReasonBentoEffects;
