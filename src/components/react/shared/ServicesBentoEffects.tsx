...
export interface ServicesBentoEffectsProps {
  enableStars?: boolean;
...
const ServicesBentoEffects: React.FC<ServicesBentoEffectsProps> = ({
  enableStars = true,
  ...
  useEffect(() => {
    ...
    cards.forEach((card) => {
      ...
      if (enableBorderGlow) {
        element.classList.add('services-card--border-glow');
      }
    ...
    if (enableSpotlight) {
      ...
      spotlight.className = 'services-global-spotlight';
...
export default ServicesBentoEffects;
