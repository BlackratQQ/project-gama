        ...
        <li key={item.label} className={item.dropdown ? 'group relative' : ''}>
          {item.dropdown ? (
            <div className="relative">
              ...
              {/* Dropdown menu */}
              <div className="dropdown-menu absolute top-full left-0 mt-2 w-64 backdrop-blur-md bg-black/80 border border-white/10 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-40">
                <div>
