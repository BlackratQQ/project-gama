...
export interface ServiceEffectsProps {
  enableStars?: boolean;
...
const ServiceMagicEffects: React.FC<ServiceEffectsProps> = ({
  enableStars = true,
  ...
  useEffect(() => {
    ...
    const cards = document.querySelectorAll('.service-bento-card');
    ...
    cards.forEach((card) => {
      ...
      if (enableBorderGlow) {
        element.classList.add('service-card--border-glow');
      }
    ...
    if (enableSpotlight) {
      ...
      spotlight.className = 'service-global-spotlight';
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const section = document.querySelector('.service-bento-section');
...
export default ServiceMagicEffects;
